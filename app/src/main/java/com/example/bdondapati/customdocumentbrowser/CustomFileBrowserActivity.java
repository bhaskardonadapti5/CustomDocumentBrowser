...
public class CustomFileBrowserActivity extends AppCompatActivity {
...
//    String[] videoFormats = new String[]{"FLV", "AVI", "MOV", "MP4", "ASF", "MPG", "WMV", "3GP", "RM", "SWF"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = CustomFileBrowserActivity.this;
    ...
    class GetDocumentTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(CustomFileBrowserActivity.this);
    ...
    class CustomAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
        ...
        public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
            ...
            holder1.tvDate.setText(CommonUtils.getDateFromMillis(records.get(position).getFile().lastModified()));
